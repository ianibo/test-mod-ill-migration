...
VOLUME /tmp
ENV VERTICLE_FILE mod-ill.war
ENV VERTICLE_HOME /
COPY service/build/libs/mod-ill-*.*.*.jar mod-ill.war
EXPOSE 8080/tcp
...
# CMD java -Djava.security.egd=file:/dev/./urandom -Xshareclasses -Xscmx50M -Xtune:virtualized -jar /mod-ill.war
