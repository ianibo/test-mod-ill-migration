...
* RES_AWAIT_PICKING - Pull slip printed, waiting to be picked
    * [Manual] supplierCheckInToIll
        * RES_CHECKED_IN_TO_ILL
        * RES_AWAIT_LMS_CHECKOUT
        * RES_AWAIT_PROXY_BORROWER

* RES_AWAIT_PROXY_BORROWER - Unable to complete check-in to ill, no PROXY borrower for borrowing library

* RES_CHECKED_IN_TO_ILL - Item checked out of host LMS and into Ill
    * supplierMarkShipped
        * RES_ITEM_SHIPPED
