...
class ActionEventResultList implements MultiTenant<ActionEventResultList> {
    ...
    static public final String REQUESTER_INFORMED_NOT_SUPPLY                 = 'requesterInformedNotSupply';
    static public final String REQUESTER_INFORMED_RETURNED                   = 'requesterInformedReturn';
    static public final String REQUESTER_INFORMED_SHIPPED                    = 'requesterInformedShipped';
    static public final String REQUESTER_INFORMED_WILL_SUPPLY                = 'requesterInformedWillSupply';
    ...
    static public final String RESPONDER_CHECK_INTO_ILL                 = 'responderCheckInToIll';
    static public final String RESPONDER_CHECKED_INTO_ILL_IND           = 'responderCheckedIntoIllInd';
    ...
    static public final String CDL_RESPONDER_CHECK_INTO_ILL             = 'cdlResponderCheckInToIll';
