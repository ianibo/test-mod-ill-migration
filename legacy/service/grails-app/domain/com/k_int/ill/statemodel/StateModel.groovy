...
import com.k_int.ill.referenceData.availableActions.BaseAvailableActions;
...
class StateModel implements MultiTenant<StateModel> {
    ...
    public static final String MODEL_REQUESTER_COPY               = 'PatronRequestCopy';
    ...
    public static final String MODEL_RESPONDER_COPY               = 'ResponderCopy';
    public static final String MODEL_CDL_RESPONDER                = 'CDLResponder';

	static public final List<StatusStage> activeStages    = [ StatusStage.ACTIVE, StatusStage.ACTIVE_PENDING_CONDITIONAL_ANSWER, StatusStage.ACTIVE_SHIPPED ];
	static public final List<StatusStage> completedStages = [ StatusStage.COMPLETED ];
...
""";
    ...
    static public StateModel ensure(
        String code,
        String name = null,
		BaseAvailableActions baseAvailableActions = null,
		...
		// If we have been supplied some available actions then load them
		if (baseAvailableActions != null) {
			baseAvailableActions.load(stateModel);
		}
    ...
    public static List<Status> getActiveStates(String modelCode) {
        return(getStatesByStage(modelCode, activeStages));
    }

    public static List<Status> getCompletedStates(String modelCode) {
        return(getStatesByStage(modelCode, completedStages));
    }
