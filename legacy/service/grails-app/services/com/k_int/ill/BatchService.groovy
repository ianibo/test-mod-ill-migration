...
public class BatchService {
        ...
        boolean appendDateTime)
    {
        ...
        createBatch(institution, description, appendDateTime, patronRequests, result);
        ...
        boolean wantBatch = false)
    {
        ...
        createBatch(institution, description, appendDateTime, patronRequests, result, wantBatch);
