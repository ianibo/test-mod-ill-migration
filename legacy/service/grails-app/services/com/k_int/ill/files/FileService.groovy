...
public class FileService {
     ...
     */
    public FileDefinitionCreateResult create(
        ...
        if (fileType && description && multipartFile) {
            ...
            FileUpload fileUpload = fileUploadService.save(institution, multipartFile);
            if (fileUpload == null) {
     ...
     */
    public FileFetchResult fetch(Institution institution, String fileDefinitionId) {
        ...
        if (fileDefinitionId) {
            ...
            if (fileDefinition == null) {
                ...
                result = fetch(institution, fileDefinition);
            }
        } else {
     ...
     */
    public FileFetchResult fetch(Institution institution, FileDefinition fileDefinition) {
        FileFetchResult result = new FileFetchResult();
        if (fileDefinition == null) {
            ...
            result.inputStream = fileUploadService.getInputStreamFor(institution, fileDefinition.fileUpload.fileObject);
