...
public class JasperReportService {
    ...
    public InputStream executeReport(
        ...
        try{
            ...
            // Compile the report
            JasperReport jasperReport = getReport(institution, fileDefinition, fallbackReportResource);
        ...
        if (report == null) {
            ...
            try {
                ...
                if (fileDefinition == null) {
                    ...
                    fetchResult = fileService.fetch(institution, fileDefinition);
                }
