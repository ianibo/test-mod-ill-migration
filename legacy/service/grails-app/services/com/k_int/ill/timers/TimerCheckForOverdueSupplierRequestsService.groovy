...
""";
	...
	public void performTask(String tenant, Institution institution, String config) {
		...
		List<PatronRequest> requests = PatronRequest.findAll(OVERDUE_REQUESTS_QUERY, queryparameters);
		if ((requests != null) && (requests.size() > 0)) {
			requests.each { request ->
                ...
                try {
                    ...
                    // Create the audit
                    illApplicationEventHandlerService.auditEntry(request, previousState, request.stateModel.overdueStatus, "Request is Overdue", null);
