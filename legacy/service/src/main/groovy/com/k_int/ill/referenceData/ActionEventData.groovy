...
import com.k_int.ill.statemodel.UndoStatus;
...
public class ActionEventData {
	...
	public void load() {
        ...
        ActionEvent.ensure(Actions.ACTION_RESPONDER_SUPPLIER_CHECK_INTO_ILL, 'The item(s) has been checked out of the responders LMS to Ill', true, StateModel.MODEL_RESPONDER.capitalize() + Actions.ACTION_RESPONDER_SUPPLIER_CHECK_INTO_ILL.capitalize(), ActionEventResultList.RESPONDER_CHECK_INTO_ILL, false, true, UndoStatus.YES);
        ActionEvent.ensure(Actions.ACTION_RESPONDER_SUPPLIER_CHECK_INTO_ILL_AND_MARK_SHIPPED, 'The item(s) have been checked into ill from the responders LMS and shipped to the requester', true, StateModel.MODEL_RESPONDER.capitalize() + Actions.ACTION_RESPONDER_SUPPLIER_CHECK_INTO_ILL_AND_MARK_SHIPPED.capitalize(), ActionEventResultList.RESPONDER_CHECK_IN_AND_SHIP);
        ActionEvent.ensure(Actions.ACTION_RESPONDER_SUPPLIER_CHECKOUT_OF_ILL, 'The item(s) has been checked backed into the responders LMS from Ill', true, StateModel.MODEL_RESPONDER.capitalize() + Actions.ACTION_RESPONDER_SUPPLIER_CHECKOUT_OF_ILL.capitalize(), ActionEventResultList.RESPONDER_ITEM_RETURNED, true);
        ...
        ActionEvent.ensure(Actions.ACTION_REQUESTER_INFORMED_NOT_SUPPLY, 'The supplier has informed us that they cannot supply the item', true, "GenericDoNothing", ActionEventResultList.REQUESTER_INFORMED_NOT_SUPPLY);
        ActionEvent.ensure(Actions.ACTION_REQUESTER_INFORMED_RETURNED, 'The supplier has informed us that the item has been returned', true, "GenericDoNothing", ActionEventResultList.REQUESTER_INFORMED_RETURNED);
        ActionEvent.ensure(Actions.ACTION_REQUESTER_INFORMED_SHIPPED, 'The supplier has informed us that the item has been shipped', true, "GenericDoNothing", ActionEventResultList.REQUESTER_INFORMED_SHIPPED);
        ActionEvent.ensure(Actions.ACTION_REQUESTER_INFORMED_WILL_SUPPLY, 'The supplier has informed us that they will supply the item', true, "GenericDoNothing", ActionEventResultList.REQUESTER_INFORMED_WILL_SUPPLY);
        ...
        ActionEvent.ensure(Events.EVENT_STATUS_REQ_BORROWING_LIBRARY_RECEIVED_INDICATION, 'Status has changed to Borrowing Library Received', false, eventServiceName(Events.EVENT_STATUS_REQ_BORROWING_LIBRARY_RECEIVED_INDICATION), ActionEventResultList.REQUESTER_NO_STATUS_CHANGE);
        ...
        ActionEvent.ensure(Events.EVENT_STATUS_REQ_REQUEST_SENT_TO_SUPPLIER_INDICATION, 'Status has changed to Sent to Supplier', false, eventServiceName(Events.EVENT_STATUS_REQ_REQUEST_SENT_TO_SUPPLIER_INDICATION), ActionEventResultList.REQUESTER_NO_STATUS_CHANGE);
        ...
        ActionEvent.ensure(Events.EVENT_STATUS_RES_CHECKED_IN_TO_ILL_INDICATION, 'Status has changed to Checked into Ill', false, eventServiceName(Events.EVENT_STATUS_RES_CHECKED_IN_TO_ILL_INDICATION), ActionEventResultList.RESPONDER_CHECKED_INTO_ILL_IND);
