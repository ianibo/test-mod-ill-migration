...
import com.k_int.ill.statemodel.ActionEventResult;
...
//        saveRestoreState: RefdataValueData.ACTION_EVENT_RESULT_SAVE_RESTORE_SAVE,
    ...
    private static Map responderISO18626ReceivedCopy = [
        code: 'responderISO18626ReceivedCopy',
        description: 'Requester has said they have received the items',
        result: true,
        status: Status.RESPONDER_COMPLETE,
        qualifier: ActionEventResultQualifier.QUALIFIER_COPY,
        saveRestoreState: null,
        nextActionEvent: null
    ];
    ...
    private static Map requesterInformedNotSupplyOK = [
        code: 'requesterInformedNotSupplyOK',
        description: 'Informed supplier cannot supply',
        result: true,
        status: Status.PATRON_REQUEST_UNFILLED,
        qualifier: null,
        saveRestoreState: null,
    ...
    private static Map requesterInformedReturnedOK = [
        code: 'requesterInformedReturnedOK',
        description: 'Informed supplier has received the item',
        result: true,
        status: Status.PATRON_REQUEST_REQUEST_COMPLETE,
        qualifier: null,
        saveRestoreState: null,
    ...
    private static Map requesterInformedShippedOK = [
        code: 'requesterInformedShippedOK',
        description: 'Informed that the supplier has shipped the item',
        result: true,
        status: Status.PATRON_REQUEST_SHIPPED,
        qualifier: null,
        saveRestoreState: null,
    ...
    private static Map requesterInformedWillSupplyOK = [
        code: 'requesterInformedWillSupplyOK',
        description: 'Requester has agreed to the conditions',
        result: true,
        status: Status.PATRON_REQUEST_EXPECTS_TO_SUPPLY,
        qualifier: null,
    ...
    private static Map requesterReceivedOKCopy = [
        code: 'requesterReceivedOKCopy',
        description: 'Requester has received a copy request from the responder',
        result: true,
        status: Status.PATRON_REQUEST_REQUEST_COMPLETE,
        qualifier: ActionEventResultQualifier.QUALIFIER_COPY,
        saveRestoreState: null,
    ...
    private static Map responderCheckInAndShipOK = [
        ...
        description: 'Responder has successfully checked the item(s) out of the LMS into ill and shipped the item',
        result: true,
    ...
    private static Map responderCheckInAndShipCheckedInFailure = [
        ...
        description: 'Responder has successfully checked the item(s) into ill but failed to ship the item(s)',
        result: false,
    ...
    private static Map responderCheckInToIllOK = [
        code: 'responderCheckInToIllOK',
        description: 'Responder has successfully checked the items out of the LMS into ill',
        result: true,
        status: Status.RESPONDER_AWAIT_SHIP,
        qualifier: null,
        saveRestoreState: null,
    ...
    private static Map responderCheckInToIllFailure = [
        code: 'responderCheckInToIllFailure',
        description: 'Responder has failed to check out 1 or more items out of the LMS into ill',
        result: false,
        status: Status.RESPONDER_AWAIT_PICKING,
        qualifier: null,
        saveRestoreState: null,
    ...
    private static Map responderCheckedIntoIllIndOK = [
        code: 'responderCheckedIntoIllIndOK',
        description: 'Status change to Checked into Ill',
        result: true,
        status: Status.RESPONDER_AWAIT_SHIP,
        qualifier: null,
        saveRestoreState: null,
    ...
    private static Map requesterInformedNotSupplyList = [
        code: ActionEventResultList.REQUESTER_INFORMED_NOT_SUPPLY,
        description: 'Informed supplier cannot fulfil the request',
        model: StateModel.MODEL_REQUESTER,
        results: [
            requesterInformedNotSupplyOK
        ]
    ];

    private static Map requesterInformedReturnedList = [
        code: ActionEventResultList.REQUESTER_INFORMED_RETURNED,
        description: 'Informed supplier the item has been returned to the supplier',
        model: StateModel.MODEL_REQUESTER,
        results: [
            requesterInformedReturnedOK
        ]
    ];

    private static Map requesterInformedShippedList = [
        code: ActionEventResultList.REQUESTER_INFORMED_SHIPPED,
        description: 'Informed supplier has shipped the item',
        model: StateModel.MODEL_REQUESTER,
        results: [
            requesterInformedShippedOK
        ]
    ];

    private static Map requesterInformedWillSupplyList = [
        code: ActionEventResultList.REQUESTER_INFORMED_WILL_SUPPLY,
        description: 'Informed supplier will fulfil the request',
        model: StateModel.MODEL_REQUESTER,
        results: [
            requesterInformedWillSupplyOK
        ]
    ];
    ...
    private static Map responderCheckInAndShipList = [
        ...
        description: 'The responder checks the item(s) into ill and ships them',
        model: StateModel.MODEL_RESPONDER,
        results: [
    ...
    private static Map responderCheckInToIllList = [
        code: ActionEventResultList.RESPONDER_CHECK_INTO_ILL,
        description: 'The responder has said that they will supply the item(s) ',
        model: StateModel.MODEL_RESPONDER,
        results: [
            responderCheckInToIllFailure,
            responderCheckInToIllOK
        ]
    ];

    private static Map responderCheckedIntoIllIndList = [
        code: ActionEventResultList.RESPONDER_CHECKED_INTO_ILL_IND,
        description: 'Status has changed to Checked into Ill',
        model: StateModel.MODEL_RESPONDER,
        results: [
            responderCheckedIntoIllIndOK
        ]
    ];
    ...
    // CDL responder
    private static Map cdlResponderCheckInToIllOK = [
        code: 'cdlResponderCheckInToIllOK',
        description: 'Responder has successfully checked the items out of the LMS into ill',
        result: true,
    ...
    private static Map cdlResponderCheckInToIllList = [
        code: ActionEventResultList.CDL_RESPONDER_CHECK_INTO_ILL,
        description: 'The responder has said that they will supply the item(s) ',
        model: StateModel.MODEL_CDL_RESPONDER,
        results: [
            responderCheckInToIllFailure,
            cdlResponderCheckInToIllOK,
        ]
    ];
    ...
    private static Map[] allResultLists = [
		...
		requesterInformedNotSupplyList,
		requesterInformedReturnedList,
		requesterInformedShippedList,
		requesterInformedWillSupplyList,
        ...
        responderCheckInToIllList,
        responderCheckedIntoIllIndList,
