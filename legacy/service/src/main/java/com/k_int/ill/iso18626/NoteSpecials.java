...
public class NoteSpecials {
    ...
    public static final String ADD_LOAN_CONDITION           = SPECIAL_WRAPPER + "IllAddLoanCondition" + SPECIAL_WRAPPER;
    public static final String AGREE_LOAN_CONDITION         = SPECIAL_WRAPPER + "IllLoanConditionAgreeResponse" + SPECIAL_WRAPPER;
    public static final String AWAITING_CONDITION_CONFIRMED = SPECIAL_WRAPPER + "IllSupplierAwaitingConditionConfirmation" + SPECIAL_WRAPPER;
    public static final String CONDITIONS_ASSUMED_AGREED    = SPECIAL_WRAPPER + "IllSupplierConditionsAssumedAgreed" + SPECIAL_WRAPPER;
	public static final String DELIVERY_URL                 = SPECIAL_WRAPPER + "deliveryUrl" + SPECIAL_SEPARATOR;
    public static final String ILL_FIELD                    = SPECIAL_WRAPPER + "IllField";
    public static final String LAST_SEQUENCE                = SPECIAL_WRAPPER + "lastSeq";
    public static final String SEQUENCE                     = SPECIAL_WRAPPER + "seq";
    public static final String UPDATE_FIELD                 = SPECIAL_WRAPPER + "IllUpdatedField";
    ...
    public static final String FIELD_PATRON_REFERENCE              = "PatronReference";
    ...
    public static final String FIELD_PUBLICATION_DATE_OF_COMPONENT = "PublicationDateOfComponent";
    ...
    public static final String ILL_FIELD_PATRON_REFERENCE_PREFIX              = ILL_FIELD + SPECIAL_FIELD_SEPARATOR + FIELD_PATRON_REFERENCE + SPECIAL_SEPARATOR;
    public static final String ILL_FIELD_PUBLICATION_DATE_OF_COMPONENT_PREFIX = ILL_FIELD + SPECIAL_FIELD_SEPARATOR + FIELD_PUBLICATION_DATE_OF_COMPONENT + SPECIAL_SEPARATOR;
}
