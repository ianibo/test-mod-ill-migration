...
@Slf4j
class IllActionServiceSpec extends Specification implements ServiceUnitTest<IllActionService> {

  def 'test date parse'(String datestr, String format, expected_time) {
