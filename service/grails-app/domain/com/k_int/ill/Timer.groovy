...
class Timer implements MultiTenant<Timer> {
  ...
  /** The institution the timer belongs to, if null it applies to all institutions */
  ...
  static mapping = {
    ...
    executeAtDayStart column : 'tr_execute_at_day_start', defaultValue : "false"
          institution column : 'tr_institution_id'
  }
  	...
  	public static Timer ensure(
        ...
        // These are global timers, so ensure the institution field is null (after migration they will not be null ...)
        timer.institution = null;
