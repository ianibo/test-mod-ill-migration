...
public class GenericCodeNameService<TDomainClass> {
     ...
     */
    public TDomainClass ensureExists(Institution institution, String code, String name, Closure additionalFieldsUpdate = null) {
        ...
        TDomainClass instance = domainClass.findByCodeAndInstitution(code, institution);
                ...
                try {
                    ...
                    domainClass.withNewTransaction {
                        ...
                        if (exists) {
                            ...
                            instance = domainClass.findByCodeAndInstitution(code, institution);
