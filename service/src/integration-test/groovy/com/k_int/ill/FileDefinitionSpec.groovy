...
class FileDefinitionSpec extends TestBase {
    ...
    void "Configure Tenants for S3 storage"(String tenantId, String key, String value) {
        ...
        where:
            tenantId   | key             | value
            TENANT_ONE | "S3SecretKey"   | "ILL_AGG_SECRET_KEY"
            TENANT_ONE | "S3Endpoint"    | "http://minio:9000"
            TENANT_ONE | "S3AccessKey"   | "ILL_AGG_ACCESS_KEY"
            TENANT_ONE | "S3BucketName"  | "ill-general"
    ...
    void "Upload_File"(String tenantId, String fileContents, String fileContentType, String filename) {
        when:"We upload a file"
            ...
            def uploadResponse = doPost("${baseUrl}/ill/fileDefinition/fileUpload".toString(), null, null, {
    ...
    void "Download_File"(String tenantId, String ignore) {
        when:"We download a file"
            ...
            def downloadResponse = doGet("${baseUrl}ill/fileDefinition/fileDownload/${testctx.fileDefinition.id}");
