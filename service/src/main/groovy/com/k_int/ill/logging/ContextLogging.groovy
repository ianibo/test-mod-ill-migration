...
public class ContextLogging extends MDC {
    ...
    static public final String ACTION_ADD_FRIEND               = "addFriend";
    static public final String ACTION_AVAILABILITY             = "availability";
    static public final String ACTION_BULK_ACTION              = "bulkAction";
    static public final String ACTION_BY_ID                    = "byId";
    static public final String ACTION_BY_QUERY                 = "byQuery";
    static public final String ACTION_CAN_CREATE_REQUEST       = "canCreateRequest";
    static public final String ACTION_CAN_MANAGE               = "canManage";
    static public final String ACTION_CREATE                   = "create";
    static public final String ACTION_CREATE_EDIT_DETAILS      = "createEditDetails";
    ...
    static public final String ACTION_FIND_MORE_SUPPLIERS      = "findMoreSuppliers";
    static public final String ACTION_FIND_SYMBOL              = "findSymbol";
    static public final String ACTION_FRESHEN                  = "freshen";
    static public final String ACTION_FROM_STATES              = "fromStates";
    static public final String ACTION_GENERATE                 = "generate";
    ...
    static public final String ACTION_HEALTH                   = "health";
    static public final String ACTION_IMPORT                   = "import";
    static public final String ACTION_INDEX                    = "index";
    static public final String ACTION_INSTITUTIONS             = "institutions";
    static public final String ACTION_ISO18626                 = "iso18626";
    static public final String ACTION_MANAGE_INSTITUTION       = "manageInstitution";
    ...
    static public final String ACTION_MODIFY_GROUPS            = "modifyGroups";
    static public final String ACTION_MODIFY_INSTITUTIONS      = "modifyInstitutions";
    static public final String ACTION_MODIFY_USERS             = "modifyUsers";
    static public final String ACTION_NEW_REQUEST_DETAILS      = "newRequestDetails";
    static public final String ACTION_OPEN_URL                 = "openUrl";
    static public final String ACTION_PASS_THROUGH             = "passThrough";
    static public final String ACTION_PERFORM                  = "perform";
    ...
    static public final String ACTION_QUERY                    = "query";
    ...
    static public final String ACTION_TEST_EXTERNAL_LOCATE     = "testExternalLocate";
    ...
    static public final String ACTION_TOKEN                    = "token";
    static public final String ACTION_TOKEN_VALUES             = "tokenValues";
    static public final String ACTION_UPDATE                   = "update";
    static public final String ACTION_USERS                    = "users";
