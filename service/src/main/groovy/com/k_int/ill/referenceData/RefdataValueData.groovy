...
/**
 * Class that contains the Reference Data values required by ILL
 * @author Chas
 *
 */
@Slf4j
public class RefdataValueData {
    ...
    public static final String VOCABULARY_SEARCH_ATTRIBUTE                 = 'SearchAttribute';
    public static final String VOCABULARY_SEARCH_ATTRIBUTE_REQUEST         = 'SearchAttributeRequest';
    public static final String VOCABULARY_SEARCH_COMPLETENESS              = "SearchCompleteness";
    public static final String VOCABULARY_SEARCH_OPERATOR                  = 'SearchOperator';
    public static final String VOCABULARY_SEARCH_POSITION                  = "SearchPosition";
    public static final String VOCABULARY_SEARCH_RELATION                  = 'SearchRelation';
    public static final String VOCABULARY_SEARCH_STRUCTURE                 = "SearchStructure";
    public static final String VOCABULARY_SEARCH_TRUNCATION                = "SearchTruncation";
    public static final String VOCABULARY_SERVICE_BUSINESS_FUNCTION        = 'Service.BusinessFunction';
    public static final String VOCABULARY_SERVICE_TYPE                     = 'Service.Type';
    ...
    public static final String REQUEST_ROUTING_ADAPTER_SHARED_INDEX = 'SharedIndex';
	public static final String REQUEST_ROUTING_ADAPTER_SHARED_Z3950 = 'SharedIndexAndZ3950';
    public static final String REQUEST_ROUTING_ADAPTER_STATIC       = 'Static';
	public static final String REQUEST_ROUTING_ADAPTER_Z3950        = 'Z3950';
	
	// These values will be used by the appropriate engine to map onto the appropriate protocol value
	public static final String SEARCH_ATTRIBUTE_AUTHOR                    = "author";
	public static final String SEARCH_ATTRIBUTE_IDENTIFIER                = "identifier";
	public static final String SEARCH_ATTRIBUTE_ISBN                      = "isbn";
	public static final String SEARCH_ATTRIBUTE_ISSN                      = "issn";
	public static final String SEARCH_ATTRIBUTE_LOCAL_SYSTEM_ID           = "localSystemId";
	public static final String SEARCH_ATTRIBUTE_OCLC_NUMBER               = "oclcNumber"; 
	public static final String SEARCH_ATTRIBUTE_SUPPLIER_UNIQUE_RECORD_ID = "supplierUniqueRecordId"; 
	public static final String SEARCH_ATTRIBUTE_TITLE                     = "title";

	// These values map onto the properties on the patron request record	
	public static final String SEARCH_ATTRIBUTE_REQUEST_AUTHOR                    = "author";
	public static final String SEARCH_ATTRIBUTE_REQUEST_ISBN                      = "isbn";
	public static final String SEARCH_ATTRIBUTE_REQUEST_ISSN                      = "issn";
	public static final String SEARCH_ATTRIBUTE_REQUEST_LOCAL_SYSTEM_ID           = "supplierUniqueRecordId";
	public static final String SEARCH_ATTRIBUTE_REQUEST_OCLC_NUMBER               = "oclcNumber"
	public static final String SEARCH_ATTRIBUTE_REQUEST_SUPPLIER_UNIQUE_RECORD_ID = "supplierUniqueRecordId"; 
	public static final String SEARCH_ATTRIBUTE_REQUEST_TITLE                     = "title"

	// Search completeness	
	public static final String SEARCH_COMPLETENESS_COMPLETE_FIELD      = "CompleteField";
	public static final String SEARCH_COMPLETENESS_COMPLETE_SUBFIELD   = "CompleteSubfield";
	public static final String SEARCH_COMPLETENESS_INCOMPLETE_SUBFIELD = "IncompleteSubfield";
	...
	// Search position
	public static final String SEARCH_POSITION_ANY_POSITION_IN_FIELD = "AnyPositionInField";
	public static final String SEARCH_POSITION_FIRST_IN_FIELD        = "FirstInField";
	public static final String SEARCH_POSITION_FIRST_IN_SUBFIELD     = "FirstInSubfield";

	// Search relation operators
	public static final String SEARCH_RELATION_EQUAL                 = "equal";
	public static final String SEARCH_RELATION_GREATER_THAN          = "greaterThan";
	public static final String SEARCH_RELATION_GREATER_THAN_OR_EQUAL = "greaterThanOrEqual";
	public static final String SEARCH_RELATION_LESS_THAN             = "lessThan";
	public static final String SEARCH_RELATION_LESS_THAN_OR_EQUAL    = "lessThanOrEqual";
	public static final String SEARCH_RELATION_NOT_EQUAL             = "notEquals";

	// Search structure
	public static final String SEARCH_STRUCTURE_DATE      = "Date";
	public static final String SEARCH_STRUCTURE_KEY       = "Key";
	public static final String SEARCH_STRUCTURE_PHRASE    = "Phrase";
	public static final String SEARCH_STRUCTURE_WORD      = "Word";
	public static final String SEARCH_STRUCTURE_WORD_LIST = "WordList";
	public static final String SEARCH_STRUCTURE_YEAR      = "Year";

	// Search truncation	
	public static final String SEARCH_TRUNCATION_LEFT           = "Left";
	public static final String SEARCH_TRUNCATION_LEFT_AND_RIGHT = "LeftAndRight";
	public static final String SEARCH_TRUNCATION_RIGHT          = "Right";
    ...
    public static final String SHARED_INDEX_ADAPTER_OPEN_RS  = 'OpenRS';
    ...
    public static final String YES_NO_OTHER_NO    = 'No';
    public static final String YES_NO_OTHER_OTHER = 'Other';
    public static final String YES_NO_OTHER_YES   = 'Yes';
   ...
   /**
    ...
    private CustomPropertyDefinition ensureRefdataProperty(String name, boolean local, String category, String label = null) {
        ...
        if (rdc != null) {
            ...
            log.error("Unable to find category ${category}");
        }
        return result;
    }
    ...
    private void load() {
        try {
            ...
            RefdataValue.lookupOrCreate(VOCABULARY_SHARED_INDEX_ADAPTER, SHARED_INDEX_ADAPTER_OPEN_RS);
            ...
            RefdataValue.lookupOrCreate(VOCABULARY_YES_NO_OTHER, YES_NO_OTHER_NO);
            RefdataValue.lookupOrCreate(VOCABULARY_YES_NO_OTHER, YES_NO_OTHER_OTHER);
            RefdataValue.lookupOrCreate(VOCABULARY_YES_NO_OTHER, YES_NO_OTHER_YES);
            ...
            renameRefdata(VOCABULARY_REQUEST_ROUTING_ADAPTER, 'FOLIOSharedIndex', REQUEST_ROUTING_ADAPTER_SHARED_INDEX);
            RefdataValue.lookupOrCreate(VOCABULARY_REQUEST_ROUTING_ADAPTER, REQUEST_ROUTING_ADAPTER_SHARED_INDEX);
            RefdataValue.lookupOrCreate(VOCABULARY_REQUEST_ROUTING_ADAPTER, REQUEST_ROUTING_ADAPTER_SHARED_Z3950);
			RefdataValue.lookupOrCreate(VOCABULARY_REQUEST_ROUTING_ADAPTER, REQUEST_ROUTING_ADAPTER_STATIC);
			RefdataValue.lookupOrCreate(VOCABULARY_REQUEST_ROUTING_ADAPTER, REQUEST_ROUTING_ADAPTER_Z3950);
			
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_ATTRIBUTE, SEARCH_ATTRIBUTE_AUTHOR);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_ATTRIBUTE, SEARCH_ATTRIBUTE_IDENTIFIER);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_ATTRIBUTE, SEARCH_ATTRIBUTE_ISBN);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_ATTRIBUTE, SEARCH_ATTRIBUTE_ISSN);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_ATTRIBUTE, SEARCH_ATTRIBUTE_LOCAL_SYSTEM_ID);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_ATTRIBUTE, SEARCH_ATTRIBUTE_OCLC_NUMBER);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_ATTRIBUTE, SEARCH_ATTRIBUTE_SUPPLIER_UNIQUE_RECORD_ID);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_ATTRIBUTE, SEARCH_ATTRIBUTE_TITLE);
			
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_ATTRIBUTE_REQUEST, SEARCH_ATTRIBUTE_REQUEST_AUTHOR);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_ATTRIBUTE_REQUEST, SEARCH_ATTRIBUTE_REQUEST_ISBN);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_ATTRIBUTE_REQUEST, SEARCH_ATTRIBUTE_REQUEST_ISSN);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_ATTRIBUTE_REQUEST, SEARCH_ATTRIBUTE_REQUEST_LOCAL_SYSTEM_ID);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_ATTRIBUTE_REQUEST, SEARCH_ATTRIBUTE_REQUEST_OCLC_NUMBER);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_ATTRIBUTE_REQUEST, SEARCH_ATTRIBUTE_REQUEST_SUPPLIER_UNIQUE_RECORD_ID);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_ATTRIBUTE_REQUEST, SEARCH_ATTRIBUTE_REQUEST_TITLE);
			
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_OPERATOR, SEARCH_OPERATOR_AND);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_OPERATOR, SEARCH_OPERATOR_NOT);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_OPERATOR, SEARCH_OPERATOR_OR);

			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_POSITION, SEARCH_POSITION_ANY_POSITION_IN_FIELD);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_POSITION, SEARCH_POSITION_FIRST_IN_FIELD);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_POSITION, SEARCH_POSITION_FIRST_IN_SUBFIELD);
			
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_STRUCTURE, SEARCH_STRUCTURE_DATE);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_STRUCTURE, SEARCH_STRUCTURE_KEY);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_STRUCTURE, SEARCH_STRUCTURE_PHRASE);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_STRUCTURE, SEARCH_STRUCTURE_WORD);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_STRUCTURE, SEARCH_STRUCTURE_WORD_LIST);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_STRUCTURE, SEARCH_STRUCTURE_YEAR);
			
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_TRUNCATION, SEARCH_TRUNCATION_LEFT);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_TRUNCATION, SEARCH_TRUNCATION_LEFT_AND_RIGHT);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_TRUNCATION, SEARCH_TRUNCATION_RIGHT);
			
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_COMPLETENESS, SEARCH_COMPLETENESS_COMPLETE_SUBFIELD);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_COMPLETENESS, SEARCH_COMPLETENESS_COMPLETE_FIELD);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_COMPLETENESS, SEARCH_COMPLETENESS_INCOMPLETE_SUBFIELD);
			
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_RELATION, SEARCH_RELATION_EQUAL);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_RELATION, SEARCH_RELATION_GREATER_THAN);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_RELATION, SEARCH_RELATION_GREATER_THAN_OR_EQUAL);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_RELATION, SEARCH_RELATION_LESS_THAN);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_RELATION, SEARCH_RELATION_LESS_THAN_OR_EQUAL);
			RefdataValue.lookupOrCreate(VOCABULARY_SEARCH_RELATION, SEARCH_RELATION_NOT_EQUAL);
			
			RefdataValue.lookupOrCreate(VOCABULARY_SERVICE_TYPE, Directory.SERVICE_TYPE_HTTP);
			RefdataValue.lookupOrCreate(VOCABULARY_SERVICE_TYPE, Directory.SERVICE_TYPE_ISO18626_2017);
			RefdataValue.lookupOrCreate(VOCABULARY_SERVICE_TYPE, Directory.SERVICE_TYPE_ISO18626_2021);
			RefdataValue.lookupOrCreate(VOCABULARY_SERVICE_TYPE, Directory.SERVICE_TYPE_NCIP);
			RefdataValue.lookupOrCreate(VOCABULARY_SERVICE_TYPE, Directory.SERVICE_TYPE_OAI_PMH);
			RefdataValue.lookupOrCreate(VOCABULARY_SERVICE_TYPE, Directory.SERVICE_TYPE_RTAC);
			RefdataValue.lookupOrCreate(VOCABULARY_SERVICE_TYPE, Directory.SERVICE_TYPE_Z3950);

			RefdataValue.lookupOrCreate(VOCABULARY_SERVICE_BUSINESS_FUNCTION, SERVICE_BUSINESS_FUNCTION_CIRC);
			RefdataValue.lookupOrCreate(VOCABULARY_SERVICE_BUSINESS_FUNCTION, SERVICE_BUSINESS_FUNCTION_HARVEST);
			RefdataValue.lookupOrCreate(VOCABULARY_SERVICE_BUSINESS_FUNCTION, SERVICE_BUSINESS_FUNCTION_ILL);
			RefdataValue.lookupOrCreate(VOCABULARY_SERVICE_BUSINESS_FUNCTION, SERVICE_BUSINESS_FUNCTION_RTAC);
			RefdataValue.lookupOrCreate(VOCABULARY_SERVICE_BUSINESS_FUNCTION, SERVICE_BUSINESS_FUNCTION_RS_STATS);
